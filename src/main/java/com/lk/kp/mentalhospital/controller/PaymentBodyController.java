...
import com.lk.kp.mentalhospital.dto.tm.PaymentTM;
...
public class PaymentBodyController implements Initializable {
    ...
    @FXML
    void paymentResetBtnActionClicked(ActionEvent event) {

    }

    @FXML
    void paymentSaveBtnActionClicked(ActionEvent event) {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        methodCombo.getItems().addAll("Cash","Card");
